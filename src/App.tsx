              ...
              <div className="flex-1 flex flex-col relative">
                <div className="bg-[#1F1F1F] p-4 border-b border-[#2D2D2D] shadow-lg">
                  <div className="flex items-center justify-between">
                    <h2 className="text-[#E0E0E0] text-lg font-medium">
                      {chatTitle}
                    </h2>
                    {selectedWorkflow && (
                  ...
                  <form onSubmit={handleSubmit} className="flex space-x-3">
                    {(selectedWorkflow?.supports_documents || selectedWorkflow?.supports_images) && (
                      <div className={`relative ${isInputDisabled ? 'opacity-50 cursor-not-allowed' : ''}`} title={
                        selectedWorkflow?.supports_documents && selectedWorkflow?.supports_images
                          ? 'Upload documents (.pdf, .doc, .docx, .txt, .wav, .mp3) or images (.png, .jpg, .jpeg, .gif)'
                          : selectedWorkflow?.supports_documents
                            ? 'Upload documents (.pdf, .doc, .docx, .txt, .wav, .mp3)'
                        ...
                        <input
                          ...
                          className="hidden"
                          id="file-upload"
                          accept={`${selectedWorkflow?.supports_documents ? '.pdf,.doc,.docx,.txt,.wav,.mp3' : ''}${
                            selectedWorkflow?.supports_documents && selectedWorkflow?.supports_images ? ',' : ''
